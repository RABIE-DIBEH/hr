...
const NFCClock = () => {
  ...
  return (
    <div className="min-h-screen bg-luxury-bg flex items-center justify-center p-6 text-white font-sans">
      <div className="max-w-md w-full bg-slate-800 rounded-[2.5rem] p-10 shadow-2xl border border-slate-700 text-center relative overflow-hidden">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-xl font-bold tracking-tight">نظام الحضور الذكي</h1>
        ...
        <div className={`w-48 h-48 mx-auto rounded-full border-4 flex items-center justify-center mb-10 transition-all duration-500 ${
          ...
          loading ? 'border-blue-500 border-t-transparent animate-spin' : 'border-slate-700 bg-slate-700/30'
        }`}>
        ...
        <button 
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-slate-700 py-4 rounded-2xl font-bold transition-all active:scale-95 shadow-lg shadow-blue-900/20"
        >
