              ...
              {logs.map((log, idx) => (
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="font-bold text-slate-100 text-lg">{log.date}</p>
                      <p className="text-sm text-slate-500 font-medium">إجمالي ساعات العمل: {log.hours} ساعة</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-12">
                    <div className="flex gap-8 text-center">
                      <div>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mb-1">Entry</p>
                        <p className="font-mono font-bold text-slate-200">{log.in}</p>
                      </div>
                      <div>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mb-1">Exit</p>
                        <p className="font-mono font-bold text-slate-200">{log.out}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase ${
                        log.status === 'Verified' ? 'bg-green-500/10 text-green-400' : 'bg-orange-500/10 text-orange-400'
                      }`}>
                        {log.status}
                      </span>
