...
public class SecurityConfigDev {
    ...
    private final com.hrms.security.SecurityHeadersConfig securityHeadersConfig;

    public SecurityConfigDev(JwtAuthenticationFilter jwtAuthenticationFilter,
                             StructuredLoggingFilter structuredLoggingFilter,
                             com.hrms.security.SecurityHeadersConfig securityHeadersConfig) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow all localhost ports for development flexibility
